...
public class BasicoJPQLTest extends EntityManagerTest {
    ...
    public void projetarOResultado() {
        String jpql = "select x.id, x.nome from Produto x";
...
//        Assert.assertTrue(String.class.equals(lista.get(0).getClass()));
    ...
    public void buscarPorIdentificador() {
        ...
        //find.(Pedido.class,1)
        TypedQuery<Pedido> pedidoTypedQuery = this.entityManager.createQuery("select p from Pedido p where p.id=1", Pedido.class);
