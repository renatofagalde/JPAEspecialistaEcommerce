...
public class PassandoParametrosCriteriaTest extends EntityManagerTest {
    ...
    public void passarParametroDate() {
        ...
        //prefiro com o objeto
        typedQuery.setParameter(parameterExpressionData, dataInicial.getTime(), TemporalType.TIMESTAMP);
    ...
    public void passarParametro_1() {
        ...
        ParameterExpression<Integer> parameterExpressionIdObject = criteriaBuilder.parameter(Integer.class, "id");

        criteriaQuery.where(criteriaBuilder.equal(root.get("id"), parameterExpressionIdObject));

        TypedQuery<Pedido> typedQuery = entityManager.createQuery(criteriaQuery);
        typedQuery.setParameter(parameterExpressionIdObject, 1);
